        ...
        this@toSections.reversed().forEach {
            add(
                    Section().apply {
                        ...
                        add(ProfileItem(app.getString(R.string.label_number_accumulated_credits_program_profile), it.nbCreditsCompletes.toString()))
                        add(ProfileItem(app.getString(R.string.label_number_registered_credits_program_profile), it.nbCreditsInscrits.toString()))
                        add(ProfileItem(app.getString(R.string.label_number_completed_courses_program_profile), it.nbCrsReussis.toString()))
